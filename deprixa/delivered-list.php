        ...
        <div class="wrapper">
			...
			<div class="row">
                    ...
                    <div class="card-box table-responsive">
						    <h4 class="header-title m-t-0 m-b-20">Delivered List</h4>
						<table border="0" align="center">
							<tr>				
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="javascript:reportedeliveryPDF();" class="btn btn-primary">Export to <strong>PDF</strong></a></td>
							</tr>
						</table>
						  <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
							<?php  					
								$result3 = mysql_query("SELECT * FROM courier WHERE status_delivered = 'Delivered'  ORDER BY cid");
							...
							?> 
							  <tr>							  
										  ...
										  <td><img src="images/deliver.png" alt="x" border="0" height="15" width="20" /><?php echo $row['status_delivered']; ?></td>           
							  </tr>
								<?php } ?>	
							</tbody>
							<?php } ?>
							...
							<tbody>
							<?php  					
								$result3 = mysql_query("SELECT * FROM courier WHERE status_delivered = 'Delivered' and officename='".$_SESSION["user_type"]."' ORDER BY cid");
								while($row = mysql_fetch_array($result3)) {					
							?> 
							  <tr>							  
										  <td align="center">
