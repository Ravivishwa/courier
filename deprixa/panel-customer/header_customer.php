                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
							...
							<li class="has-submenu">
                                <a href="add-courier-customer.php"><i class="fa fa-cubes"></i> <span> ADD SHIPPING </span> </a>
                            </li>								
							<li class="has-submenu">
                                <a href="paybill.php"><i class="zmdi zmdi-collection-text"></i> <span> PAY BILL </span> </a>
