...
<body>
<div class="news blue">
<span>Big Dot News</span><span class="text1" ><marquee>Welcome To Big Dot Courier.....</marquee></span>
</div>
<div class="fw green-bg">
            <section class="track-num">
                <h3>Home Step Pic-Up Your Parcel</h3>
				...
				<form action="tracking-result.php" method="post" name="form" id="form" >
                    <div class="form-group mob-track">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="Consignment" id="Consignment" placeholder="Name,Mobile Number,Pincode">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary" name="Submit" onClick="MM_validateForm('Consignment','','R');return document.MM_returnValue"><img src="deprixa/images/Tracking.png" alt="x" />pic-up my parcel</button>
